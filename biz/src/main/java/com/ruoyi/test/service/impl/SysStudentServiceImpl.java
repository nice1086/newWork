...
import com.ruoyi.test.mapper.SysStudentMapper;
...
public class SysStudentServiceImpl extends ServiceImpl<SysStudentMapper, SysStudent> implements ISysStudentService
{
    ...
    public List<SysStudent> queryList(SysStudent sysStudent)
    {
        ...
        QueryWrapper<SysStudent> queryWrapper2=new QueryWrapper<>();
        queryWrapper2.eq("student_id", 1);
        List<SysStudent> sysStudents=this.getBaseMapper().selectList(queryWrapper2);
