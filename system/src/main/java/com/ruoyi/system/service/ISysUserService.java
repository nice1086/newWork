...
public interface ISysUserService
{
    ...
    String sonImportUser(List<SysUser> userList, Boolean isUpdateSupport, String operName);

    int insertSonUser(SysUser user);
     ...
     * @return 企业状态
     */
    String selectCompanyStatus(String userName);
}
